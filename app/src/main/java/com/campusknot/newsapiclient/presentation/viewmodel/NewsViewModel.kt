...
class NewsViewModel(
    ...
    /**
     * If we want to use context in the ViewModel then we need to use AndroidViewModel also
     * we meed to app application as a parameter
     */
    ...
    //Get search result from UseCase class
