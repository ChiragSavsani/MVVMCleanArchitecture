...
import com.campusknot.newsapiclient.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var sharedViewModel: NewsViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedViewModel = ViewModelProvider(this, factory).get(NewsViewModel::class.java)
    }
}